    ...
    <section className={cn('surface overflow-hidden p-1', className)}>
      <div className="relative overflow-hidden rounded-[1.5rem] bg-card">
        ...
        <button
          ...
          className="icon-button focus-ring absolute left-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-foreground hover:bg-white"
        >
        ...
        <button
          ...
          className="icon-button focus-ring absolute right-4 top-1/2 inline-flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-foreground hover:bg-white"
        >
