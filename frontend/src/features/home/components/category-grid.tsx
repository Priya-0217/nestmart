          ...
          <motion.article whileHover={{ y: -6 }} transition={TRANSITION_STANDARD} className="surface group overflow-hidden transition-all duration-300 ease-in-out">
            <Link href={category.href}>
              <div className="relative aspect-[4/3]">
                <ProductImage src={category.image} alt={category.name} fill className="object-cover transition-all duration-500 ease-in-out group-hover:scale-105" sizes="(max-width: 768px) 100vw, 25vw" />
